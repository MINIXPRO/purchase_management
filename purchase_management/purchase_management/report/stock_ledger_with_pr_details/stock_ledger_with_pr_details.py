...
def get_columns(filters):
	...
	columns.extend(
		[
			...
			{
				"label": _("Supplier Expiry"),
				"fieldname": "custom_supplier_expiry_",
				"fieldtype": "Data",
				"width": 110,
			},
			{
				"label": _("Supplier Expiry Date"),
				"fieldname": "custom_supplier_expiry_date",
				"fieldtype": "Date",
				"width": 110,
			},
			{
