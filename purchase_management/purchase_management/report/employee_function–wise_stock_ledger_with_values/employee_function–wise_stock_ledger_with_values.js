...
frappe.query_reports["Employee Function–Wise Stock Ledger with Values"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
...
erpnext.utils.add_inventory_dimensions("Employee Function–Wise Stock Ledger with Values", 10);