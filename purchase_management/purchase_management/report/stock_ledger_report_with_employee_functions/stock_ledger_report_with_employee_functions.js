...
frappe.query_reports["Stock Ledger Report With Employee Functions"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		{
			fieldname: "employee_function",
			label: __("Employee Function"),
			fieldtype: "Link",
			options: "Employee Function",
		},
		{
...
erpnext.utils.add_inventory_dimensions("Stock Ledger Report with Employee Functions", 10);
